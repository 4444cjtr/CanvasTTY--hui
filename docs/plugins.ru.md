...
5. В том же разделе плагин можно включить, выключить, удалить, добавить или убрать его HOME widgets. Если manifest объявляет `settingsContribution`, карточка плагина также показывает отдельное действие **Настройки**.
